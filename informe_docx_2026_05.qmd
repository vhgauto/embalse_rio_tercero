---
title: "**INFORME DE CALIDAD DEL AGUA DEL EMBALSE RIO TERCERO (Mayo de 2026)**"
...
abstract-title: ""
abstract: A Solicitud de la Autoridad de Cuencas | Mayo de 2026
format:
  docx:
    toc: false
...
#| tbl-cap: Determinaciones fisico-químicas básicas obtenidas para el embalse Río Tercero **Mayo de 2026**.

source("scripts/tabla_parametros.R")
tabla_parametros_md
```

La @fig-param-campo muestra la dinámica de las principales variables medidas durante esta campaña, su comparación con el mes anterior (`{r} mes_prev_etq` 2026) y el mismo mes del año previo (Mayo de `{r} año_actual - 1`).
